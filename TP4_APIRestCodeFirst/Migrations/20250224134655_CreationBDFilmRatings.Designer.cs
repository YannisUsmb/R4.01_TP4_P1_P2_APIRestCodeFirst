...
namespace TP4_APIRestCodeFirst.Migrations
{
    ...
    [Migration("20250224134655_CreationBDFilmRatings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TP4_APIRestCodeFirst.Models.EntityFramework.Film", b =>
                {
                    ...
                    b.HasIndex(new[] { "Titre" }, "uqix_film_titre");

                    b.ToTable("t_e_film_flm", "public");
                });

            modelBuilder.Entity("TP4_APIRestCodeFirst.Models.EntityFramework.Notation", b =>
                {
            ...
            modelBuilder.Entity("TP4_APIRestCodeFirst.Models.EntityFramework.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex(new[] { "Mail" }, "uq_utilisateur_mail")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4_APIRestCodeFirst.Models.EntityFramework.Notation", b =>
                {
                    b.HasOne("TP4_APIRestCodeFirst.Models.EntityFramework.Film", "FilmNote")
                        .WithMany("NotesFilm")
                        .HasForeignKey("FilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TP4_APIRestCodeFirst.Models.EntityFramework.Utilisateur", "UtilisateurNotant")
